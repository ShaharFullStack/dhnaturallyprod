...
export class ProductModel {
    ...
    private static insertValidationSchema = Joi.object({
        ...
        short_description_en: Joi.string().max(500).optional(),
        short_description_he: Joi.string().max(500).optional(),
        price: Joi.number().min(0).precision(2).required(),
        sale_price: Joi.number().min(0).precision(2).optional().allow(null),
        ...
        meta_title_en: Joi.string().max(200).optional(),
        meta_title_he: Joi.string().max(200).optional(),
        meta_description_en: Joi.string().max(300).optional(),
        meta_description_he: Joi.string().max(300).optional(),
    ...
    private static updateValidationSchema = Joi.object({
        ...
        description_en: Joi.string().min(10).max(5000).required(),
        description_he: Joi.string().min(10).max(5000).required(),
        short_description_en: Joi.string().max(500).optional().allow(''),
        short_description_he: Joi.string().max(500).optional().allow(''),
        price: Joi.number().min(0).precision(2).required(),
        sale_price: Joi.number().min(0).precision(2).optional().allow(null),
        ...
        meta_title_en: Joi.string().max(200).optional().allow(''),
        meta_title_he: Joi.string().max(200).optional().allow(''),
        meta_description_en: Joi.string().max(300).optional().allow(''),
        meta_description_he: Joi.string().max(300).optional().allow(''),
        is_active: Joi.boolean().optional(),
        is_featured: Joi.boolean().optional(),
        sort_order: Joi.number().integer().optional(),
        image: Joi.object().optional(),
